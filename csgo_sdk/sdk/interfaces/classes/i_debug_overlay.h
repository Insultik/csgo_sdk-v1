...
public:
	...
	virtual void add_box_overlay( const vec3_t& origin, const vec3_t& mins, const vec3_t& max, const vec3_t& orientation, int r, int g, int b, int a, float duration ) = 0;
	...
	virtual void add_box_overlay2( const vec3_t& origin, const vec3_t& mins, const vec3_t& max, const vec3_t& orientation, color_t face_color, color_t edge_color, float duration ) = 0;
