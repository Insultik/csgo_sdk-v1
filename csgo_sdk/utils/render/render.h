...
namespace render {
	...
	__forceinline vec2_t calc_text_size( std::string txt, fonts::fonts_e font_ = fonts::verdana_11 ) {
	...
	void text( std::string text, vec2_t text_position, color_t color, fonts::fonts_e font = fonts::verdana_11, int flags = font_none, bool menu = false );
	void instance( );
	void reset( );
	void draw( );
